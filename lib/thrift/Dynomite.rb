...
module Dynomite
  class Client
    ...
    def recv_put()
      ...
      return result.success unless result.success.nil?
      raise result.fail unless result.fail.nil?
      raise TApplicationException.new(TApplicationException::MISSING_RESULT, 'put failed: unknown result')
    end
    ...
    def recv_has()
      ...
      return result.success unless result.success.nil?
      raise result.fail unless result.fail.nil?
      raise TApplicationException.new(TApplicationException::MISSING_RESULT, 'has failed: unknown result')
    end
    ...
    def recv_remove()
      ...
      return result.success unless result.success.nil?
      raise result.fail unless result.fail.nil?
      raise TApplicationException.new(TApplicationException::MISSING_RESULT, 'remove failed: unknown result')
    end
  ...
  class Get_args
    ...
    attr_accessor :key
    FIELDS = {
      1 => {:type => TType::STRING, :name => 'key'}
    }
  end

  class Get_result
    include ThriftStruct
    attr_accessor :success, :fail
    FIELDS = {
      0 => {:type => TType::STRUCT, :name => 'success', :class => GetResult},
      1 => {:type => TType::STRUCT, :name => 'fail', :class => FailureException}
    }
  end

  class Put_args
    include ThriftStruct
    attr_accessor :key, :context, :data
    FIELDS = {
      1 => {:type => TType::STRING, :name => 'key'},
      2 => {:type => TType::STRING, :name => 'context'},
      3 => {:type => TType::STRING, :name => 'data'}
    }
  end
